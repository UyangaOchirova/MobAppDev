package com.mirea.uyangaochirova.cryptoloader;
...
import com.mirea.uyangaochirova.cryptoloader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    public void	onClickButton(View view){
        ...
        bundle.putByteArray(MyLoader.ARG_WORD, encryptMsg(text, secretKey));
