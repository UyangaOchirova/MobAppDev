package com.mirea.uyangaochirova.camera;
...
import com.mirea.uyangaochirova.camera.databinding.ActivityMainBinding;
...
//                                _authorities, _photoFile);
    ...
    public void onRequestPermissionsResult(int _requestCode, @NonNull String[] _permissions,
        ...
        if(_requestCode == REQUEST_CODE_PERMISSION) {
            ...
            Log.d("CameraPermission", "Camera permission result: " + _isWork);
            Log.d("Camera", "Попытка запуска камеры");
            Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            startActivity(intent); // Это строка запуска камеры
